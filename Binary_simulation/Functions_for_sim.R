...
Eff_monitor=function(dat, n,post_tox, eff_cap, Cf, n_post,Tox_data){
    ...
    for (j in 1:length(n)) {
        ...
        if(num_T0[j]==0){
            ...
            Eff0_outcome[[j]]<-((OG_Eff0_outcome[[j]] - 0)/
                                    (1-0))
        }
        ...
        if(num_T1[j]==0){
            ...
            Eff1_outcome[[j]]<-((OG_Eff1_outcome[[j]] - 0)/
                                    (1-0))
        }
        ...
        unrestricted_post_mu0[,j]<-(unrestricted_post_mu0[,j]* (1-0) +
                                        0 )
        unrestricted_post_mu1[,j]<-(unrestricted_post_mu1[,j]* (1-0) +
                                        0 )
